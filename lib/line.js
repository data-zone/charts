...
function getOption(props) {
  ...
  var _legend = renderFields.map(function (_ref, i) {
    var label = _ref.label;
    return { name: label, color: color[i] };
  });
  var labels = [];
  var series = renderFields.reduce(function (last, _ref2) {
    var key = _ref2.value;
    return _extends({}, last, _defineProperty({}, key, []));
  }, {});

  data.forEach(function (item) {
    labels.push(renderLabel(item));

    renderFields.forEach(function (_ref3) {
      var key = _ref3.value;
  ...
  return _extends({}, restOption, {
    ...
    series: renderFields.map(function (_ref4, i) {
